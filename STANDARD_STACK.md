...
## Sprachwahl: Python oder TypeScript?

**Faustregel: Gibt es einen Browser? → TypeScript. Gibt es keinen Browser? → Python.**

| Projekttyp | Sprache | Begründung |
|------------|---------|------------|
| Web-App / Dashboard / UI | **TypeScript** | Browser ist das Ziel |
| Full-Stack (Frontend + Backend zusammen) | **TypeScript** | Next.js verbindet beides |
| Desktop-App (Electron) | **TypeScript** | Chromium-basiert |
| Design System / Komponenten-Library | **TypeScript** | Konsumenten sind Browser |
| AI/LLM-Integration, Agenten, Prompts | **Python** | Ökosystem stärker (Anthropic SDK, LangChain etc.) |
| Scripting, Automation, CLI-Tools | **Python** | Weniger Overhead, schneller produktiv |
| Security-Tooling, Scanning | **Python** | Die meisten Libraries existieren nur für Python |
| Reines Backend / API ohne UI | **Python** | FastAPI ist minimal und schnell |

**Graubereich – Backend-API mit AI-Funktionen:**  
Auch hier Python, weil AI-Libraries erstklassig sind und FastAPI wenig Overhead hat.
TypeScript nur wenn das Backend direkt UI-Komponenten shared (z.B. via Next.js API Routes).
